...
class KerjakanLatihanSoalPage extends StatefulWidget {
  final String? id;
  final String? title;
  const KerjakanLatihanSoalPage({Key? key, this.id, this.title})
      : super(key: key);
  static const String route = "kerjakan_latihan_soal_page";
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: answereChecked
            ? R.colors.primary.withOpacity(0.5)
            : Colors.transparent,
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Image.asset(R.assets.icSuccess),
          const Text(
